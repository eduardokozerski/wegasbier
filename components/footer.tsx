    ...
    <footer className="bg-card border-t border-border/50 py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          {/* Logo & About */}
          <div>
            <Link href="/" className="relative inline-block h-12 w-40 mb-6">
              <Image
            ...
            <p className="text-muted-foreground leading-relaxed">
              Nascida no interior de Minas Gerais, a Wegas Bier traz o melhor chopp artesanal 
        ...
        <div className="pt-8 border-t border-border/50 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Cervejaria Wegas. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
